...
import { bloodBanks, bloodTypes } from '../dataBanks';
      ...
      <section className="w-full max-w-[93%]  mx-auto bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 mb-10">
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center gap-6 border-t border-black/5 pt-8">
          <div className="flex items-center justify-center">
           ...
           <Button  variant="secondary" size="lg" className="w-full md:w-auto bg-green-700 hover:bg-green-800 text-white px-10 py-6 rounded-2xl font-bold flex items-center justify-center gap-3 transition-transform active:scale-95 shadow-lg"> <FaSearch />
             بحث عن بنوك الدم 
          </Button>
        </div>
      </section>
