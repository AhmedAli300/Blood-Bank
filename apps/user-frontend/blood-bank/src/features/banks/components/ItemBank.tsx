...
import { FaRegCheckCircle, FaPlusCircle, FaClock } from 'react-icons/fa';
import { MdOutlineGpsFixed } from 'react-icons/md';
import Image from 'next/image';
import { FaDroplet } from 'react-icons/fa6';
import Link from 'next/link';
import { bloodTypeItem } from '../dataBanks';
    ...
    <>
      ...
      {/* CTA Button */}
        <div className="flex justify-end w-full"> 
             <Button asChild variant="secondary" size="lg" className="w-fit px-5 mt-6 bg-[#2D8A5B] hover:bg-[#236b46] text-white py-6 rounded-2xl font-bold text-md flex items-center justify-center gap-2 transition-all shadow-lg active:scale-[0.98]">
