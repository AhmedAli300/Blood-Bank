    ...
    <>
      ...
      <div className="max-w-xl w-full text-center space-y-4 animate-in zoom-in duration-500">
        ...
        <div className="space-y-4 pt-4">
            <Button asChild variant="secondary" size="lg" className="flex items-center justify-center w-full max-w-md mx-auto bg-[#2D8A5B] hover:bg-[#236b46] text-white py-7 rounded-2xl font-bold text-lg transition-all shadow-lg active:scale-95">
                <Link href="/home" >
                    العودة للرئيسية
                </Link>
            </Button>
            <Button asChild variant="secondary" size="lg" className="flex items-center justify-center w-full max-w-md mx-auto bg-white text-gray-600 py-7 rounded-2xl font-bold text-lg border border-gray-100 hover:bg-gray-50 transition-all">
