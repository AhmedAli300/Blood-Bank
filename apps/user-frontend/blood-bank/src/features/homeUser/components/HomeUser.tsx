...
import { khadma } from '../dataHome';
import { Button } from '@/components/ui/button';

export default function HomeUser() {
  return (
   <div className="min-h-screen  p-6 space-y-10 dir-rtl text-right">
    <div className="w-full max-w-[93%] mx-auto ">
      
      {/* 1. الـ Banner الرئيسي */}
      <div className="relative h-62.5 w-full rounded-3xl overflow-hidden shadow-xl">
        <Image 
          src="/images/unnamed.png" // الصورة اللي في الـ public
          alt="تبرع بالدم" 
          fill 
          className="object-cover brightness-50" 
        />
        <div className="absolute inset-0  flex flex-col justify-center text-white  p-6 space-y-4">
          ...
          <p className="max-w-md opacity-90">مساهمتك البسيطة قد تكون هي الأمل الوحيد لإنقاذ حياة مريض في حاجة ماسة.</p>
           <Button  variant="secondary" size="lg" className="bg-[#338E5B] hover:bg-[#338E5B] w-fit text-white px-10 py-2 rounded-xl font-bold hover:scale-105 transition-transform ">
            ابدأ الآن
          </Button>
        </div>
      </div>
      ...
      <div>
        <h3 className="text-xl font-bold text-gray-800 border-r-4 border-[#338E5B] pr-3 mb-6 mt-3 italic"> خدمات سريعة</h3>
