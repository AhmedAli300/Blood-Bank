...
export default function Setting() {
  ...
  return (
    <>
      ...
      {/* حذف الحساب */}
      <Button  variant="secondary" size="lg" className="w-full max-w-[93%] mx-auto bg-[#FEF2F2] text-[#EF4444] py-6 cursor-pointer rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-red-100 transition-all mb-4">
