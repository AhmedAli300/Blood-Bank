    ...
    <>
      ...
      <div className="w-full max-w-[60%] mx-auto ">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button  variant="secondary" size="lg" className="w-10 h-10 bg-[#34A853] text-white rounded-full flex items-center justify-center shadow-lg hover:bg-emerald-700 transition-colors">
            <IoAdd size={24} />
          </Button>
        </div>
        ...
        {/* Add New Card Button */}
        <Button  variant="secondary" size="lg" className="w-full bg-[#34A853] text-white py-6  rounded-2xl font-bold mt-10 flex items-center justify-center gap-2 hover:bg-[#2d8f47] shadow-lg shadow-emerald-100 transition-all">
