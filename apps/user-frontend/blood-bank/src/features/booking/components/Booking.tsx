...
"use client";
import { FaPlus, FaMinus, FaCloudUploadAlt } from 'react-icons/fa';
import Link from 'next/link';
import { useState } from 'react';
import {  FaFileAlt, FaCheckCircle, FaTimesCircle } from 'react-icons/fa';
import { bloodTypes } from '../BookingData';
    ...
    <div className="min-h-screen bg-[#F8F9FB] font-tajawal text-right" dir="rtl">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 shadow-[0_-4px_10px_rgba(0,0,0,0.03)]">
        ...
        <div className="max-w-[95%] mx-auto mt-4">
            <Button asChild variant="secondary" size="lg" className="w-full bg-[#2D8A5B] text-white py-6 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-[#236b46] transition-all shadow-lg shadow-green-900/10">
