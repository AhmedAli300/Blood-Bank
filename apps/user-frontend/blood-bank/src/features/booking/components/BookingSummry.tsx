        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className=" rounded-3xl  ">
              ...
              <div className="bg-white p-6 rounded-b-2xl border border-t-0 border-emerald-50 space-y-6">
                ...
                <div className="space-y-5">
                    <Field>
                        <FieldLabel htmlFor="numbarCard" className="block text-md text-gray-500 mb-0 font-bold"> رقم البطاقة </FieldLabel>
                        <div className="relative">
                            <Input placeholder="0000 0000 0000 0000"
                                className="w-full bg-gray-50 border-none p-4 py-6 rounded-xl text-left tracking-widest focus-visible:ring-2  focus-visible:ring-emerald-500 outline-none" 
                            />
                        </div>
                    </Field>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Field>
                            <FieldLabel htmlFor="data" className="block text-md font-bold text-gray-500 mb-2"> تاريخ الانتهاء</FieldLabel>
                            <Input id='data'  placeholder="YY / MM" type='date'
                                className="w-full bg-gray-50 border-none p-4 py-6 rounded-xl text-center tracking-widest focus-visible:ring-2  focus-visible:ring-emerald-500 outline-none" 
                            />
                        </Field>
                    
                        <Field>
                            <FieldLabel htmlFor="ccv" className="flex items-center  justify-start gap-1 text-md font-bold text-gray-500 mb-2"> رمز التحقق (CVV)
                                <AiOutlineInfoCircle className="text-gray-400 cursor-pointer" />
                            </FieldLabel>
                            <Input id='ccv'  placeholder="123"
                                className="w-full bg-gray-50 border-none p-4 py-6 rounded-xl text-center tracking-widest focus-visible:ring-2  focus-visible:ring-emerald-500 outline-none" 
                            />
                        </Field>
                    </div>
                    ...
                    <Field>
                        <FieldLabel htmlFor="namecard" className="block text-md font-bold text-gray-500 mb-2 text-right">اسم حامل البطاقة</FieldLabel>
                        <Input id='namecard' placeholder="الاسم كما يظهر على البطاقة"
                            className="w-full bg-gray-50 border-none p-4 py-6 rounded-xl text-right tracking-widest focus-visible:ring-2  focus-visible:ring-emerald-500 outline-none" 
                        />
                    </Field>
                </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm ring-1 ring-gray-100">
               ...
               <Button asChild variant="secondary" size="lg" className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-7 rounded-2xl font-bold flex items-center justify-center gap-3 transition-all shadow-lg shadow-emerald-200 active:scale-95 group">
