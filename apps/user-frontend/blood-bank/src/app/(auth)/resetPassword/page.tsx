      ...
      <div className="bg-white rounded-[2rem] shadow-2xl flex flex-col md:flex-row overflow-hidden max-w-4xl w-full border border-gray-100">
        ...
        <div className="md:w-2/3  p-8 md:p-14 md:py-8 bg-white">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-1">
                {/* <h4 >رمز التحقيق</h4> */}
              <label className="text-xs font-bold text-gray-500 mr-1">تم إرسال رمز التحقيق إلي بريدك الإلكتروني example@mail.com</label>
              <div className="relative group flex items-center justify-center">
                <input 
                  type="text" 
                  placeholder="153495" 
                  className="w-full p-2 pr-2 mt-2 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-[#2D8A56]/20 focus:border-[#2D8A56] outline-none transition-all" 
                />
            ...
            {/* زر تسجيل الدخول */}
            <Link href={"resetAccountPassword"} className="w-full bg-[#2D8A56] hover:bg-[#256f45] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all shadow-lg shadow-green-900/10 group">
             تأكيد
